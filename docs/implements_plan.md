...
- 工数目安: 25〜32人日
- 実装方針: 機能クラスター単位で順次実装し、各タスク内でテスト + 実装を完結させる。
- 期間目安（個人開発）: 2026-04-11〜2026-05-31

| 優先 | タスクID | 対象 | 依存 | 内容（ざっくり） | 担当 | Issue |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| P0 | T-021 | FNC-001,IF-001,SCR-001 | T-019 | 認証UseCase/API/UIのテスト + 実装（start/login callback/logout）+ 監査/例外統一（3.5人日） | 個人開発者 | Issue#T-021 |
...
| 優先 | タスクID | 対象 | 依存 | 内容（ざっくり） | 担当 | Issue |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| P0 | T-032 | E2E主要導線 | T-031 | 主要導線E2Eテスト作成 + 結合実装（3.0人日） | 個人開発者 | Issue#T-032 |
...
| 優先 | タスクID | 対象 | 依存 | 内容（ざっくり） | 担当 | Issue |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| P0 | T-039 | Release Gate | T-038 | 全テスト通過確認、未解決P1/P2=0確認（0.5人日） | 個人開発者 | Issue#T-039 |
...
| :--- | :--- | :--- | :--- |
| FNC-001 | `SCR-001`, `IF-001` | `T-021` | 認証フロー |
| FNC-002 | `SCR-008`, `IF-004`, `TBL-006` | `T-022` | 同意判定 |
| FNC-003 | `SCR-008`, `TBL-007`, `TBL-008` | `T-022` | 同意履歴 |
| FNC-004 | `SCR-003`, `SCR-004`, `TBL-002` | `T-023` | 習慣管理 |
| FNC-005 | `SCR-002`, `TBL-001` | `T-024` | 業務日付 |
| FNC-006 | `SCR-002`, `IF-002`, `TBL-003` | `T-025` | 登録/冪等 |
| FNC-007 | `SCR-002`, `TBL-003` | `T-026` | 取消 |
| FNC-008 | `SCR-005`, `SCR-006`, `TBL-004` | `T-027` | 可視化 |
| FNC-009 | `IF-003`, `IF-005`, `TBL-005`, `TBL-010` | `T-030` | 運用通知/KPI |
| FNC-010 | `SCR-007`, `TBL-001` | `T-028` | 設定更新 |
| FNC-011 | `SCR-007`, `TBL-008`, `IF-005` | `T-028` | 設定監査 |
| FNC-012 | `SCR-007`, `BAT-004`, `TBL-009` | `T-029` | 退会二段階削除 |
