...
export const T036_CONTRACT_TEST_GLOBS = [
  ...
  'tests/integration/routing/t036-red-summary.test.ts',
] as const;

export const T037_CONTRACT_TEST_GLOBS = [
  'tests/integration/routing/policy-consent-api.contract.test.ts',
  'tests/integration/routing/policy-consent-usecase.contract.test.ts',
...
export const T039_CONTRACT_TEST_GLOBS = [
...
export const T043_CONTRACT_TEST_GLOBS = [
  'tests/integration/checkin/business-date.service.contract.test.ts',
  'tests/integration/api/checkins-business-date.contract.test.ts',
...
export const T045_CONTRACT_TEST_GLOBS = [
  'tests/integration/api/checkins-idempotency.contract.test.ts',
  'tests/integration/api/checkins-authorization.contract.test.ts',
  'tests/integration/checkin/t045-red-summary.test.ts',
] as const;

export const T046_CONTRACT_TEST_GLOBS = [
  'tests/integration/api/checkins-idempotency.contract.test.ts',
  'tests/integration/api/checkins-authorization.contract.test.ts',
